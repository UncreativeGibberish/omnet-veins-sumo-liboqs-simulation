...
#define VEINSPQCSIM_VERSION_MAJOR 0
#define VEINSPQCSIM_VERSION_MINOR 1
#define VEINSPQCSIM_VERSION_PATCH 0
#define VEINSPQCSIM_VERSION_ALPHA 0
...
// VEINSPQCSIM_API macro. Allows us to use the same .h files for both building a .dll and linking against it
