...
#ifndef VEINSPQCSIM_PQCRSU_HQC_MLDSA_H_
#define VEINSPQCSIM_PQCRSU_HQC_MLDSA_H_
...
class VEINSPQCSIM_API PQCRSU_hqc_mldsa : public veins::DemoBaseApplLayer
{
public:
...
#endif /* VEINSPQCSIM_PQCRSU_HQC_MLDSA_H_ */
