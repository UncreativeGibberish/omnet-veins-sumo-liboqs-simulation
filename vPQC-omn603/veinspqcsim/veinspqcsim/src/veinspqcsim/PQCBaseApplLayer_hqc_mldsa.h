...
#ifndef VEINSPQCSIM_PQCBASEAPPLLAYER_HQC_MLDSA_H_
#define VEINSPQCSIM_PQCBASEAPPLLAYER_HQC_MLDSA_H_
...
class VEINSPQCSIM_API PQCBaseApplLayer_hqc_mldsa : public veins::DemoBaseApplLayer{
public:
...
#endif /* VEINSPQCSIM_PQCBASEAPPLLAYER_HQC_MLDSA_H_ */
